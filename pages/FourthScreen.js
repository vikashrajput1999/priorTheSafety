...
class LevelFirst extends Component {
    ...
    loadQuiz = () => {
        ...
        this.setState(() => {
            return {
                image : DataSet4 [Questions].image,
...
componentDidUpdate (prevProps, prevState) {
    ...
    else if (Questions==DataSet4.length-1){
...
computeAns = (index) => {
    ...
    render() {
        const {Questions, questions, options, score, setAnswer, Selected, image} = this.state
        return(
            <ImageBackground source = {require('../Assets/qbk3.jpeg')} style = {styles.bckimg}>
